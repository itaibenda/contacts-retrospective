...
angular
  .module('contactsRetrospectiveAppInternal', ['ngResource']);
...
angular
  .module('contactsRetrospectiveApp', ['contactsRetrospectiveAppInternal', 'contactsRetrospectiveTranslations', 'wixAngular'])
  .config(function () {
    return;
  });
